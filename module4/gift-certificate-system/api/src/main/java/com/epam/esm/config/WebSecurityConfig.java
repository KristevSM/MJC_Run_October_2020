...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers(HttpMethod.POST, "/gift-certificates/**").hasRole(ADMIN)
                .antMatchers(HttpMethod.PATCH, "/gift-certificates/**").hasRole(ADMIN)
                .antMatchers(HttpMethod.DELETE, "/gift-certificates/**").hasRole(ADMIN)
